...
Ranking separates the methods, but the deployable thresholded decision remains
near the floor for almost all crop methods.
...
attributable to matching, not partial coverage. Coverage-only assigns a constant
score to every registered image pair and ranks unregistered pairs last; its
nontrivial Rank-1 therefore comes from registration overlap, not crack evidence.
Like the $F_1$ figures these are
