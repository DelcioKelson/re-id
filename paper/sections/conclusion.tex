...
We built a benchmark that makes crack re-identification testable ---
...
crack scores $\mathbf{0.000}$. Operationally, the open-set advantage comes from
an aligned pair supporting a \emph{licensed negative}, positive evidence of
absence, where a crop embedding can only report low similarity; whether that
advantage is independent of homography-based annotation remains unresolved.
Two bounds
