...
decision itself. Those systems therefore solve measurement after correspondence
has already been supplied; they do not decide whether a newly observed crack is
the same physical defect as a gallery crack under an open-set protocol. Our
benchmark targets that missing association decision, while its real capture
scope remains within one walk-around rather than a true longitudinal study.
