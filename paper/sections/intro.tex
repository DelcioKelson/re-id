...
records: a re-photographed defect must be \emph{re-identified} --- matched to its
record, or given a new one. Wall cracks are a common and difficult case, because
...
identities --- to make that measurement (Fig.~\ref{fig:ceiling}). Capture is one
...
secondary check (Sec.~\ref{sec:hybridbench}).
